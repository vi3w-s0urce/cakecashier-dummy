...
<section class="px-32 py-5">
    <div class="flex justify-center items-center gap-x-12">
        ...
        <div class="flex flex-col">
            ...
            <h1 class="text-base text-slate-500">Silahkan masuk dengan akun kasir untuk menggunakan aplikasi</h1>
            <form action="/login" method="POST" class="mt-5">
                ...
                <button type="submit" class="w-full btn btn-primary text-slate-50 mb-3">Masuk</button>
                <p class="mb-3 text-center">atau</p>
                <a href="/signup" type="submit" class="w-full btn btn-outline btn-primary text-slate-50">Daftar</a>
            </form>
            </div>
        </div>
    </div>
